...
CREATE TABLE `CheckCodes` (
  `phone_num` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `check_code` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2019-07-04 15:04:12
